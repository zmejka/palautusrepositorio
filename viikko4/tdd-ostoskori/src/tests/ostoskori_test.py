...
class TestOstoskori(unittest.TestCase):
    ...
    def test_kahden_saman_tuotteen_jalkeen_korissa_on_oikeat_nimi_ja_maara(self):
        maito = Tuote("Maito", 3)
        self.kori.lisaa_tuote(maito)
        self.kori.lisaa_tuote(maito)
        ostos = self.kori.ostokset()[0]
    ...
    def test_kahdesta_samasta_tuotteesta_toinen_poistetaan_ja_maara_muuttuu_oikein(self):
        maito = Tuote("Maito", 3)
        self.kori.lisaa_tuote(maito)
        self.kori.lisaa_tuote(maito)
    ...
    def test_yhden_tuotteen_lisaamisen_ja_poiston_jalkeen_kori_on_tyhja(self):
        maito = Tuote("Maito", 3)
        self.kori.lisaa_tuote(maito)
        self.kori.poista_tuote(maito)
        ostos = self.kori.ostokset()
